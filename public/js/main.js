...
function displayResult(item, office) {
  ...
  if (item.photoUrl) {
    ...
    newResult.find('.headshot-container').css('background-image', 'url("' + photoUrl + '"), url(public/img/noIMG.jpg)');
  } else {
    newResult.find('.headshot-container').css('background-image', 'url(public/img/noIMG.jpg)');
  }
